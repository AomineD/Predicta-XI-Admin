...
export function MaintenanceTab() {
  ...
  return (
    <div>
      ...
      {/* Las insignias se gestionan en System → Badges. El catálogo entero
          (icono, textos, color, peso y las reglas de las nuevas) vive ahora en
          la base y lo sirve el API, así que estrenar o corregir una insignia ya
          no exige publicar una versión en las tiendas. Los ajustes globales y
          los umbrales se movieron con él para no dejar dos sitios donde tocar
          lo mismo. */}
